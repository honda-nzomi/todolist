              ...
              <div class="card" id="list1" style="border-radius: .75rem; background-color: #EFF1F2;">
                <div class="card-body py-4 px-4 px-md-5">
                      ...
                      <form action="/tasks" method="post" class="align-items-center mb-4">
                        ...
                        <div class="row">
                          <div class="text-center my-3">
                            <button type="submit" class="btn btn-dark px-5">TodoListに追加</button>
                          </div>
                        </div>
                      </form>
                  </div>
                  ...
                  　　　　<ul class="list-group list-group-horizontal rounded-0 bg-transparent">
                            ...
                            <div class="card mb-0 px-2 align-middle text-center border-0" style="font-size: 20px;">{{ $dt->format('m月d日 H時i分') }}</div>
